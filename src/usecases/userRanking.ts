...
const rules: RuleRecord = [
  [
    function match(attemp) {
      ...
      if(attemp.guessSubmission.firstTeamPoints === attemp.gameResult.firstTeamPoints && attemp.guessSubmission.secondTeamPoints === attemp.gameResult.secondTeamPoints) {
        return 5;
      }
  ...
  [
    function winnerScore(attemp) {
      ...
      if(attemp.guessSubmission.firstTeamPoints === attemp.gameResult.firstTeamPoints && attemp.gameResult.firstTeamPoints > attemp.guessSubmission.secondTeamPoints) {
        return 3;
      }

      if(attemp.guessSubmission.secondTeamPoints === attemp.gameResult.secondTeamPoints && attemp.gameResult.secondTeamPoints > attemp.gameResult.firstTeamPoints) {
        return 3;
      }
  ...
  [
    function winnerWithoutScore(attemp) {
      ...
      if(attemp.guessSubmission.firstTeamPoints === attemp.guessSubmission.secondTeamPoints || attemp.gameResult.firstTeamPoints === attemp.gameResult.secondTeamPoints) {
        return 0;
      }
